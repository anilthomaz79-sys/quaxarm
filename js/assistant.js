(function () {
  ...
  const topics = [
    ...
    },
    {
      ...
      answer:
        "Aegis is Quaxarm’s Azure estate product for cost optimisation, Microsoft Defender vulnerabilities, and resource checklists. It is available as a Quaxarm subscription, or deployed in the client’s environment. Estate information is handled confidentially and used only to operate the service. The product has been tested; implementation with prospective clients is planned.",
      links: [
        { href: "products.html", label: "Products" },
    ...
    },
    {
      ...
      answer:
        "Two products have been tested, with implementation planned with prospective clients. Testora is a digital assessment platform offered as a Quaxarm subscription. Aegis covers Azure cost, Defender, and checklists, as a subscription or in the client’s environment. Client information is treated as confidential.",
